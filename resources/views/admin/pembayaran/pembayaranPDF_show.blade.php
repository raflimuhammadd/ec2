        ...
        <div class="container">
            <div class="header">
                ...
                <div class="contact-info">
                    <span class="email">Tanggal Pembayaran </span>
                    <span class="email-val">{{ $pem->tanggal_pembayaran }}</span>
                    <span class="separator"></span>
                    <span class="phone">Jumlah Bayar </span>
                    <span class="phone-val">{{ $pem->jumlah_bayar }}</span>
                </div>
