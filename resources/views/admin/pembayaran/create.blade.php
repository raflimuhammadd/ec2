...
@section('content')
    ...
    <form method="POST" action="{{ url('admin/pembayaran/store') }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="tanggal_pembayaran" name="tanggal_pembayaran" placeholder="Masukan nama produk" type="date"
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="jumlah_bayar" name="jumlah_bayar" placeholder="Masukan Jumlah Bayar" type="text"
