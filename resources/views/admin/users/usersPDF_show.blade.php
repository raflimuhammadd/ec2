        ...
        <div class="container">
            <div class="header">
                ...
                <div class="contact-info">
                    ...
                    <span class="email-val">{{ $use->username }}</span>
                    <span class="separator"></span>
                    <span class="phone">Password </span>
                    <span class="phone-val">{{ $use->password }}</span>
                    <span class="phone">Role </span>
                    <span class="phone-val">{{ $use->role }}</span>
                </div>
